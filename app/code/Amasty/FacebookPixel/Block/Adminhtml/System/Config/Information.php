...
namespace Amasty\FacebookPixel\Block\Adminhtml\System\Config;
...
class Information extends Fieldset
{
     ...
     * @var string
     */
    private $userGuide = 'https://amasty.com/docs/doku.php?id=magento_2:facebook_pixel';
