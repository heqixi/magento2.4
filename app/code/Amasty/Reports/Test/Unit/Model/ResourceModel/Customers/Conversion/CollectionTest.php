...
class CollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetIntervalSelectAndGroupBy($isOrder, $filters, $result)
    {
        ...
        $request->expects($this->any())->method('getParams')->willReturn($filters);
    ...
    public function testGetFromFilter()
    {
        ...
        $request->expects($this->any())->method('getParams')->willReturnOnConsecutiveCalls(['from' => 'test'], []);
    ...
    public function testGetToFilter()
    {
        ...
        $request->expects($this->any())->method('getParams')->willReturnOnConsecutiveCalls(['to' => 'test'], []);
