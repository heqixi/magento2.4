...
class Collection extends \Magento\Sales\Model\ResourceModel\Order\Collection
{
    ...
    /**
     * @param \Amasty\Reports\Model\ResourceModel\Sales\Hour\Grid\Collection $collection
     */
    ...
    {
        $timezoneOffsetInUTC = $this->helper->getTimezoneOffset(false);
        $collection->getSelect()
            ->reset(\Zend_Db_Select::COLUMNS)
            ->columns([
                'period' => sprintf('HOUR(CONVERT_TZ(created_at, \'+00:00\', \'%s\'))', $timezoneOffsetInUTC),
