...
{
    const NEW_RULE_VALUE = 'new_rule';
    const DASHBOARD_VALUE = 'dashboard';
    const SALES_VALUE = 'sales';
    const OVERVIEW_VALUE = 'overview';
    const OVERVIEW_COMPARE_VALUE = 'overview_compare';
    const ORDERS_VALUE = 'orders';
    const ORDER_ITEMS_VALUE = 'order_items';
    const SALES_BY_VALUE = 'sales_by';
    const BY_HOUR_VALUE = 'by_hour';
    const BY_DAY_VALUE = 'by_day';
    const BY_COUNTRY_VALUE = 'by_country';
    const BY_COUNTRY_STATE_VALUE = 'by_country_state';
    const BY_PAYMENT_VALUE = 'by_payment';
    const BY_GROUP_VALUE = 'by_group';
    const BY_COUPON_VALUE = 'by_coupon';
    const BY_CATEGORY_VALUE = 'by_category';
    const BY_CART_PRICE_RULE_VALUE = 'by_cart_price_rule';
    const CATALOG_VALUE = 'catalog';
    const BY_PRODUCT_VALUE = 'by_product';
    const BY_ATTRIBUTES_VALUE = 'by_attributes';
    const BY_BRANDS_VALUE = 'by_brands';
    const PRODUCT_PERFORMANCE_VALUE = 'product_performance';
    const BESTSELLERS_VALUE = 'bestsellers';
    const CUSTOMERS_ALL_VALUE = 'customers_all';
    const CUSTOMERS_VALUE = 'customers';
    const RETURNING_VALUE = 'returning';
    const ABANDONED_VALUE = 'abandoned';
    const CONVERSION_RATE_VALUE = 'conversion_rate';
    const CUSTOM_VALUE = 'custom';
    const MORE_ANALYTICS = 'more_analytics';
